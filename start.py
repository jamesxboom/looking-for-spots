...
RIVER_KEYWORDS = [
    "truckee", "upper truckee", "little truckee", "truckee river",
    "carson", "east carson", "west carson", "carson river",
    "walker", "east walker", "west walker",
    "yuba", "north yuba", "south yuba",
    "american", "feather", "sacramento", "upper sac", "lower sac",
    "mccloud", "pit", "hat creek", "fall river",
    "trinity", "klamath",
    "stanislaus", "tuolumne", "merced", "kings",
    "kern", "kaweah", "owens", "hot creek",
    "san joaquin", "mokelumne", "calaveras", "cosumnes",
    "putah", "butte", "cottonwood", "elder",
    "deer creek", "mill creek", "battle creek", "clear creek",
    "donner", "prosser", "stampede", "boca", "independence",
    "pyramid", "tahoe", "mammoth", "crowley", "bridgeport", "convict",
    "dunsmuir", "siskiyou", "berryessa", "pinecrest", "davis",
]
